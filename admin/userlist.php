        ...
        <div class="table-responsive">
            <table class="table table-condensed table-primary table-responsive">
                ...
                <tbody>
                    ...
                    $news = mysqli_query($conn,"SELECT * from users order by user_id desc");
						...
						$get = mysqli_query($conn,"select * from users order by user_id desc LIMIT {$pagination->offset}, {$pagination->limit}");
